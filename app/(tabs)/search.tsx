    ...
    <SafeAreaView style={styles.container}>
          ...
          <Animated.View style={[filterAnimatedStyle, styles.filterContainer]}>
            ...
            <View style={styles.filterTags}>
              <TouchableOpacity style={[styles.filterTag, styles.filterTagActive]}>
                <Text style={styles.filterTagActiveText}>Fruits</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.filterTag}>
                <Text style={styles.filterTagText}>Vegetables</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.filterTag}>
                <Text style={styles.filterTagText}>Organic</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.filterTag}>
                <Text style={styles.filterTagText}>Salads</Text>
              </TouchableOpacity>
            </View>
          </Animated.View>
        )}
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.popularTags}>
          {['Fresh Fruits', 'Green Salads', 'Organic Box', 'Berry Mix', 'Tropical Fruits'].map((item, index) => (
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyStateText}>
            {searchQuery ? 'No results found' : 'Start typing to search for products'}
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
